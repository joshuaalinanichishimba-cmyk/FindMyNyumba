...
# Ã¢â€â‚¬Ã¢â€â‚¬ Guards & helpers Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
def require_admin(current_user: User = Depends(get_current_user)) -> User:
    # Admin-only (admin + ceo). ceo holds "*" and must reach every admin route,
    # so it is admitted here alongside admin. Finer staff access is handled by
    # per-endpoint require("...") permission guards, not this blunt gate.
...
def _user_documents(user, request: Request, verification_status: str | None) -> list:
    ...
    (verification_doc1_url / verification_doc2_url) â€” the same source admin.py's
    ...
    every deploy, so the fallback rarely yields anything in production â€” it exists
...
# Ã¢â€â‚¬Ã¢â€â‚¬ Request bodies Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
def admin_analytics_search(admin: User = Depends(require_admin), db: Session = Depends(get_db)):
    ...
    try:
        ...
        areas = []
        for name, c in (db.query(SearchLog.university, _F.count(SearchLog.id))
                          .filter(SearchLog.university.isnot(None), SearchLog.university != "")
                          .group_by(SearchLog.university)
                          .order_by(_F.count(SearchLog.id).desc()).limit(10).all()):
            areas.append({"area": name, "count": int(c)})
        for term, c in (db.query(SearchLog.query, _F.count(SearchLog.id))
                          .filter(SearchLog.query.isnot(None), SearchLog.query != "")
                          .group_by(SearchLog.query)
                          .order_by(_F.count(SearchLog.id).desc()).limit(10).all()):
            areas.append({"area": term, "count": int(c)})
...
def admin_export(filename: str, admin: User = Depends(require_admin),
    ...
    if fmt != "csv":
        raise HTTPException(status_code=501,
                            detail=f"{fmt.upper()} export not implemented yet Ã¢â‚¬â€ CSV is available.")
