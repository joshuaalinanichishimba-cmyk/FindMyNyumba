...
api_router.include_router(price_reviews.router)   # /listings/{id}/price-review, /admin/price-reviews
...
api_router.include_router(safety.router)  # /safety/verify-landlord, /admin/trust/blacklist
...
api_router.include_router(student_hosts.router, prefix="/student-host")            # legacy path
api_router.include_router(student_hosts.router, prefix="/accommodation-assistant")  # new canonical path# /api/v1/student-host/...
